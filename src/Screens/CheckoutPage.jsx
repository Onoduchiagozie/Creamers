...
function CheckoutPage({ route }) {
    ...
    const product=route.params.meal;
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff',marginVertical:30 }}>
            ...
            <View style={{ alignItems: 'center', marginTop: 30 }}>
                ...
                <Text style={{ textAlign: 'center', color: '#888', marginTop: 10, paddingHorizontal: 50 }}>
                   Enjoy your {meal} meal to the fullest!
                </Text>
            </View>
            ...
            <View style={{ margin: 20, borderWidth: 1, borderColor: '#eee', borderRadius: 15, padding: 20 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 5 }}>
                    ...
                    <Text style={{ fontWeight: '600' }}>$19.99</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15 }}>
                    <Text style={{ color: '#888' }}>Tax (10%)</Text>
                    <Text style={{ fontWeight: '600' }}>$1.80</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Grand Total</Text>
                    <Text style={{ fontWeight: 'bold', fontSize: 16, color: '#FF914D' }}>$21.78</Text>
                </View>
            </View>
